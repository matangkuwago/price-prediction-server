...
class TestEndpointResults(unittest.TestCase):
    client = TestClient(app)

    def test_result_not_yet_available(self):
        ...
        with patch('app.routers.results.AsyncResult') as mock_async_result:
            ...
            response = self.client.get(f"/results/{mock_request_id}")
    ...
    def test_result_available_prediction_error(self):
